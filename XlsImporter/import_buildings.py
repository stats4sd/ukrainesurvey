...
if response.status_code == 200:
    ...
    # #####################################
    sql_buildings = "INSERT IGNORE INTO buildings (`cluster_id`, `structure_number`, `latitude`, `longitude`, `altitude`, `precision`, `address`) VALUES (%s, %s, %s, %s, %s, %s, %s)"
